...
namespace Firma.Data.Migrations
{
    ...
    [Migration("20250604122517_ZwiekszenieDlugosciLinkTytul")]
    partial class ZwiekszenieDlugosciLinkTytul
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Firma.Data.Data.CMS.WiadomoscKontaktowa", b =>
                {
            ...
            modelBuilder.Entity("Firma.Data.Data.Intranet.Pracownik", b =>
                {
            ...
            modelBuilder.Entity("Firma.Data.Data.Intranet.Urlopy", b =>
                {
            ...
            modelBuilder.Entity("Firma.Data.Data.Menu.Danie", b =>
                {
            ...
            modelBuilder.Entity("Firma.Data.Data.Menu.Kategoria", b =>
                {
                    b.Property<int>("IdKategorii")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Firma.Data.Data.Zamowienia.MetodaPlatnosci", b =>
                {
            ...
            modelBuilder.Entity("Firma.Data.Data.Zamowienia.Zamowienie", b =>
                {
            ...
            modelBuilder.Entity("Firma.Data.Data.Intranet.Urlopy", b =>
                {
                    b.HasOne("Firma.Data.Data.Intranet.Pracownik", "Pracownik")
                        .WithMany("Urlop")
            ...
            modelBuilder.Entity("Firma.Data.Data.Menu.Danie", b =>
                {
                    b.HasOne("Firma.Data.Data.Menu.Kategoria", "Kategoria")
                        .WithMany("Dania")
            ...
            modelBuilder.Entity("Firma.Data.Data.Zamowienia.Zamowienie", b =>
                {
                    b.HasOne("Firma.Data.Data.Menu.Danie", "Danie")
                        .WithMany("Zamowienia")
                        .HasForeignKey("IdDania")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Firma.Data.Data.Zamowienia.MetodaPlatnosci", "MetodaPlatnosci")
                        .WithMany("Zamowienia")
